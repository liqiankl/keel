...
const FEATURES = [
  {
    ...
    body: "Every feature request, customer ask, and internal idea flows into one structured inbox. Triage, and route in seconds never lose signal again.",
    points: ["Multi-team isolation", "Bulk triage actions", "Source tracking (customer / internal / engineering)"],
  },
  {
    icon: BarChart2,
    color: "#30a46c",
    title: "Flexible prioritization frameworks",
    body: "Score initiatives with RICE, MoSCoW, or WSJF. Compare across frameworks and override with a reason when gut matters.",
    points: ["RICE, MoSCoW, WSJF built-in", "Undo/redo with full history"],
  },
  {
    icon: Map,
    color: "#f97316",
